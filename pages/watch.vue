  ...
  <div class="w-[100vw] ml-[-5em]">
    <div class="pl-[6em] pr-[1em] flex gap-4">
      ...
      <div class="bgColor1 p-4 w-[14em] md:w-[18em] lg:w-[24em] h-fit rounded-xl">
        <div></div>
        <div v-if="anime">
          <div class="w-[100%] h-[14em] md:h-[18em] lg:h-[24em] bg-cover animeCard cursor-pointer"
            :style="'background-image: url(https://shikimori.me/' + anime.image.original + ')'">
            <!-- Background Overlay -->
            ...
            <!--      </div>--> <!-- Временно закоменченно, в будещем можно в оверлей что-то добавить -->
          </div>
          <div class="mt-4">
      ...
      <div class="w-full flex flex-col gap-4">
        ...
        <div class="w-full h-[70vh] p-4 bgColor1 rounded-lg">
        ...
        <div class="w-full p-4 bgColor1 rounded-lg">
          <WatchAnimeInfoAccordion :description="anime.description_html" :genres="anime.genres" v-if="anime" />
          <div class="h-[35vh] flex justify-center items-center" v-else>
            <span class="loading loading-ring loading-lg" style="width: 8em;"></span> <!-- loading -->
          </div>
        </div>
      </div>
